...
export function usePatientNextRoomQueuesList(currentQueueRoomLocationUuid: string) {
  const apiUrl = `/ws/rest/v1/patientqueue?v=full&location=${currentQueueRoomLocationUuid}&status=pending`;
