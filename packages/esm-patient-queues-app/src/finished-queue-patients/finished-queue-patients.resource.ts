...
export function usePatientFinishedQueuesList(currentQueueRoomUuid: string) {
  const apiUrl = `/ws/rest/v1/patientqueue?v=full&location=${currentQueueRoomUuid}&status=finished`;
