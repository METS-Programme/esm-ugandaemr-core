...
const CarePanelMCH: React.FC<CarePanelProps> = ({ patientUuid, formEntrySub, launchPatientWorkspace }) => {
  ...
  return (
    <div className={styles.widgetCard}>
      <CardHeader title={t('mchProgram', 'MCH Program')}>
        {isLoading && (
          <InlineLoading
            status="active"
